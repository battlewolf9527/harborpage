...
/** 构建时间的本地展示形式（注入值为 ISO 字符串，缺失时省略该段） */
const buildTimeText = __BUILD_TIME__
    ...
    <div className="about-dialog-overlay" onClick={handleOverlayClick}>
      <div className="about-dialog">
        ...
        <div className="about-dialog-footer">
          <div className="about-dialog-footer-left">
            <a
            ...
            <span className="about-dialog-build-info">
              ...
              {buildTimeText ? <span className="about-dialog-build-time">{buildTimeText}</span> : null}
            </span>
          </div>
