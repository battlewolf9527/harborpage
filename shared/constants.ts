export const TRACKED_KEYS = ['settings', 'websites', 'searchEngines', 'todos', 'todoList', 'notes', 'wallpaper', 'pages', 'palette', 'paletteAliases', 'paletteLightness', 'paletteSchemes'] as const;
